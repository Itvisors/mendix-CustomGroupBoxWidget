...
public class TestData
{
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "TestGroupBox.TestData"));
	}
	...
	protected TestData(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject testDataMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("TestGroupBox.TestData", testDataMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a TestGroupBox.TestData");
	...
	{
		java.util.List<testgroupbox.proxies.TestData> result = new java.util.ArrayList<testgroupbox.proxies.TestData>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//TestGroupBox.TestData" + xpathConstraint))
			result.add(testgroupbox.proxies.TestData.initialize(context, obj));
		return result;
	}
